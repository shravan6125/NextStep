...
const StudentProfile = () => {
  ...
  const [bio, setBio] = useState('Aspiring Software Developer | Passionate Learner');
  const [education, setEducation] = useState('Diploma in Computer Science, DBATU University');
  const [skills, setSkills] = useState('React Native, JavaScript, UI/UX Design, Firebase');
  const [interests, setInterests] = useState('AI, Web Development, Open Source, Cyber Security');
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.profileImageContainer}>
          <Image
            source={require('../../assets/images/person.png')} // Default Profile Image
      ...
      <ScrollView style={styles.infoContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          <FontAwesome5 name="graduation-cap" size={24} color="#0077B6" />
          <Text style={styles.cardTitle}>Education</Text>
          <Text style={styles.cardText}>{education}</Text>
        </View>

        <View style={styles.card}>
          <MaterialIcons name="build" size={24} color="#0077B6" />
